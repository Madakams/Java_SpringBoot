...
public class TestFarmToMarketService {
	...
	public void testAddEquipment() {
		...
		Equipment equipment=new Equipment(11,"Drone",10, 30000.0,"Tamilnadu","Chennai","Poru","600015","Rajesh","8187272711","Available",user);
	...
	public void testSearchEquipment() {
		User user=new User(2,"9873626111","Mumbai","Maharastra","600115","equipmentowner","Suresh","abcd");
		Equipment equipment1=new Equipment(11,"Drone",10, 30000.0,"Tamilnadu","Chennai","Poru","600015","Rajesh","8187272711","Available",user);

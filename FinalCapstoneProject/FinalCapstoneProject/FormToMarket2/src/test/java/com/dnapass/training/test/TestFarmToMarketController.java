...
public class TestFarmToMarketController {
	...
	public void testLogin() throws Exception {
		...
		System.out.println(userService.findUser(login1.getUserid()));
	...
	public void testBookEquipment() throws Exception {
		int ecount=2;
		Equipment e = new Equipment(100,"Drone",20,30000.0,"Kerela","Cochin","Trivandrum","300021","John","8736514243","Available",user1);
